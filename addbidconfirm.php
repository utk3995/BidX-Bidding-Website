...
<div id="mainBody">
	...
	<div class="container">    
	  ...
	  <div class="span8">
	  	...
	  	<div class="col-md-6">
    		<div id="legend">
              <legend class="" style="line-height: 1.0;color:white;font-size:20px;font-family:timeburnernormal" >Your Bid has been placed successfully. In case you win this bid, you will be notified on your email address</legend>
            </div></br></br>
         <div style=""><h4 ><a href="homepage.php" style="color:white;font-family:timeburnernormal;font-size:25px;"><b>Return to Homepage &nbsp;&nbsp;&nbsp;</b></a></h4></div>
      </center>
    </div>
</div>
</div>
