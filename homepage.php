...
<div style="color:white;font-family:quango;font-size:100px;">BidX</div></br></br>
	<div style="float:left;color:white;font-family:timeburnernormal;font-size:20px;">Welcome!<strong> <?php echo $nm;?> </strong></div>
...
<!-- Sidebar end=============================================== -->
		...
		<div class="span9">		
			<div >
			&nbsp;&nbsp;&nbsp;&nbsp;<h4 style="font-family:timeburnernormal ;font-size:30px;color:white;">Popular Bids </a></h4><br></br></br>
			<div class="row-fluid">
		...
		<?php	
					...
					$sql = "select * from hot_deals join items ON hot_deals.item_id=items.item_id ";
					...
					while($row = mysqli_fetch_array($res)){
						...
						$itid=$row["item_id"];
						$hj="select * FROM bid where item_id = '$itid'";
						$result1 = mysqli_query( $connect_db,$hj);
		...
		<h4 style="font-family:timeburnernormal ;font-size:30px;color:white;">Latest Bids </a></h4><br></br></br>
			  <ul class="thumbnails">
				<?php
				$sql = "select * from items order by time_added DESC ";
					...
					$i=0;
					$cow=0;
					while(($row = mysqli_fetch_array($res)) && ($cow<3)){
						$cow = $cow+1;
						$itid=$row["item_id"];
						//echo $itid;
						$var=$row['time_added'];
				...
				<li class='span3'>
				  ...
				  <i class='tag'></i>
					<h5> ".$row["name"]." </h5>
					<a href='product.php?var=".$row["item_id"]."'><img src='".$row["link"]."' alt='' height='50px' width='70px'></a></br>
					<div class='caption'>
					
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<b>Max Mid</b> :  Rs.". $temp."</a>
					  </br>
